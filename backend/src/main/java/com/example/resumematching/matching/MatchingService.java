...
import com.example.resumematching.resume.Resume;
import com.example.resumematching.resume.ResumeRepository;
...
public class MatchingService {
    ...
    public MatchingResponse match(MatchingRequest request) {
        ...
        Set<String> jobKeywords = tokenize(request.jobDescription());
        ...
        return new MatchingResponse(score, (int) matched, total);
    }
